...
pub fn derive_as_bind_group_compute(ast: syn::DeriveInput) -> Result<TokenStream> {
        ...
        if let Some(attr_ident) = attr.path().get_ident() {
            if attr_ident == BIND_GROUP_DATA_ATTRIBUTE_NAME {
                ...
                binding_impls.push(quote! {{
                    ...
                    (
                        #binding_index,
                        bevy::render::render_resource::OwnedBindingResource::Buffer(render_device.create_buffer_with_data(
                            &bevy::render::render_resource::BufferInitDescriptor {
                                label: None,
                                usage: bevy::render::render_resource::BufferUsages::COPY_DST | bevy::render::render_resource::BufferUsages::UNIFORM,
                ...
                binding_layouts.push(quote!{
                    bevy::render::render_resource::BindGroupLayoutEntry {
                        ...
                        visibility: bevy::render::render_resource::ShaderStages::COMPUTE,
                        ty: bevy::render::render_resource::BindingType::Buffer {
                            ty: bevy::render::render_resource::BufferBindingType::Uniform,
                            has_dynamic_offset: false,
                            min_binding_size: Some(<#converted_shader_type as bevy::render::render_resource::ShaderType>::min_size()),
                        },
                        count: None,
                    }
                });
            ...
            match binding_type {
                ...
                BindingType::Storage => {
                    ...
                    let min_binding_size = if buffer {
                        ...
                        quote! {Some(<#field_ty as bevy::render::render_resource::ShaderType>::min_size())}
                    };
                        ...
                        binding_impls.push(quote! {{
                            ...
                            (
                                ...
                                bevy::render::render_resource::OwnedBindingResource::Buffer(render_device.create_buffer_with_data(
                                    &bevy::render::render_resource::BufferInitDescriptor {
                                        label: None,
                                        // CHANGE: Added COPY_SRC
                                        usage: bevy::render::render_resource::BufferUsages::COPY_DST  | bevy::render::render_resource::BufferUsages::COPY_SRC | bevy::render::render_resource::BufferUsages::STORAGE,
                                        contents: buffer.as_ref(),
                                    },
                                ))
                            )
                    ...
                    binding_layouts.push(quote! {
                        bevy::render::render_resource::BindGroupLayoutEntry {
                            ...
                            ty: bevy::render::render_resource::BindingType::Buffer {
                                ty: bevy::render::render_resource::BufferBindingType::Storage { read_only: #read_only },
                                has_dynamic_offset: false,
                        ...
                        ( #binding_index,
                          bevy::render::render_resource::OwnedBindingResource::TextureView({
                              ...
                              if let Some(handle) = handle {
                                  images.get(handle).ok_or_else(|| bevy::render::render_resource::AsBindGroupError::RetryNextUpdate)?.texture_view.clone()
                              } else {
                    ...
                    binding_layouts.push(quote! {
                        bevy::render::render_resource::BindGroupLayoutEntry {
                            ...
                            ty: bevy::render::render_resource::BindingType::StorageTexture {
                                access: bevy::render::render_resource::StorageTextureAccess::#access,
                                format: bevy::render::render_resource::TextureFormat::#image_format,
                                view_dimension: bevy::render::render_resource::#dimension,
                            },
                            count: None,
                        }
                    });
                    ...
                    binding_layouts.push(quote! {
                        bevy::render::render_resource::BindGroupLayoutEntry {
                            ...
                            ty: bevy::render::render_resource::BindingType::Texture {
                                ...
                                sample_type: bevy::render::render_resource::#sample_type,
                                view_dimension: bevy::render::render_resource::#dimension,
                            },
                            count: None,
                        }
                ...
                BindingType::Sampler => {
                    ...
                    binding_impls.push(quote! {
                        (
                            ...
                            bevy::render::render_resource::OwnedBindingResource::Sampler({
                                let handle: Option<&bevy::asset::Handle<bevy::render::texture::Image>> = (&self.#field_name).into();
                                if let Some(handle) = handle {
                                    images.get(handle).ok_or_else(|| bevy::render::render_resource::AsBindGroupError::RetryNextUpdate)?.sampler.clone()
                                } else {
                    ...
                    binding_layouts.push(quote!{
                        bevy::render::render_resource::BindGroupLayoutEntry {
                            binding: #binding_index,
                            visibility: #visibility,
                            ty: bevy::render::render_resource::BindingType::Sampler(bevy::render::render_resource::#sampler_binding_type),
                            count: None,
                        }
                    });
                }
                ...
                binding_layouts.push(quote!{
                    bevy::render::render_resource::BindGroupLayoutEntry {
                        ...
                        ty: bevy::render::render_resource::BindingType::Buffer {
                            ty: bevy::render::render_resource::BufferBindingType::Uniform,
                            has_dynamic_offset: false,
                            min_binding_size: Some(<#field_ty as bevy::render::render_resource::ShaderType>::min_size()),
                        },
                        count: None,
                    }
                });
                ...
                binding_layouts.push(quote!{
                    bevy::render::render_resource::BindGroupLayoutEntry {
                        ...
                        ty: bevy::render::render_resource::BindingType::Buffer {
                            ty: bevy::render::render_resource::BufferBindingType::Uniform,
                            has_dynamic_offset: false,
                            min_binding_size: Some(<#uniform_struct_name as bevy::render::render_resource::ShaderType>::min_size()),
                        },
                        count: None,
                    }
                });
    ...
    Ok(TokenStream::from(quote! {
        ...
        impl #impl_generics bevy_sly_compute::AsBindGroupCompute for #struct_name #ty_generics #where_clause {
...
fn get_fallback_image(
    ...
    quote! {
        match bevy::render::render_resource::#dimension {
            bevy::render::render_resource::TextureViewDimension::D1 => &fallback_image.d1,
            bevy::render::render_resource::TextureViewDimension::D2 => &fallback_image.d2,
            bevy::render::render_resource::TextureViewDimension::D2Array => &fallback_image.d2_array,
            bevy::render::render_resource::TextureViewDimension::Cube => &fallback_image.cube,
            bevy::render::render_resource::TextureViewDimension::CubeArray => &fallback_image.cube_array,
            bevy::render::render_resource::TextureViewDimension::D3 => &fallback_image.d3,
        }
    }
}
...
fn get_texture_attrs(metas: Vec<Meta>) -> Result<TextureAttrs> {
    ...
    let mut visibility = ShaderStageVisibility::compute();
